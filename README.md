...
Once you have received the .jar file, open a terminal/command window. Navigate to the location of the .jar file on your machine. Then, type java –jar MDA.jar to start the program. Follow the instructions on the terminal window to use the program.
